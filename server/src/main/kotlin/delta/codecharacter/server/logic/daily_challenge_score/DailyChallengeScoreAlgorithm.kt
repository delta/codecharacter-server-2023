...
class DailyChallengeScoreAlgorithm : ScoreAlgorithm {
    ...
    override fun getHoursSinceDailyChallengeLaunched(): Double {
        ...
        println(period.toHours().toDouble())
    ...
    override fun getDailyChallengeScore(playerCoinsUsed: Int, playerDestruction: Double, dailyChallenge: DailyChallengeEntity): Double {
        ...
        return ((getPlayerBaseScore(coinsLeftPercentage, playerDestruction, perfectBasePart, challType) + getTimeScore(perfectTimePart))*100.0).toInt()/100.0
    }
}
